...
(function () {
  ...
  var CONFIG = {
    ...
    CONV_PHONE_CLICK: 'AW-17980143249/PHONE_LABEL_HERE',    // create action in Ads, paste label
    CONV_WHATSAPP_CLICK: 'AW-17980143249/WHATSAPP_LABEL_HERE', // create action in Ads, paste label
  ...
  function fire(sendTo){if(typeof window.gtag!=='function')return;if(!sendTo||sendTo.indexOf('LABEL_HERE')!==-1)return;window.gtag('event','conversion',{send_to:sendTo});}
